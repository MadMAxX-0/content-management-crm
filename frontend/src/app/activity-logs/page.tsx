...
const LOGS: Log[] = [
  { id: "e1", level: "info", action: "USER LOGOUT", actionColor: "#6b7280", category: "User", tag: "Aria", icon: "user",
    title: "User Aria logged out", actor: "Aria", email: "team@luminacrm.app", time: "18:57:25", day: "today",
  ...
  { id: "e2", level: "info", action: "USER LOGIN", actionColor: "#7c3aed", category: "User", tag: "Aria", icon: "user",
    title: "User Aria logged in", actor: "Aria", email: "team@luminacrm.app", time: "18:53:05", day: "today",
  ...
  { id: "e3", level: "success", action: "USER CREATED", actionColor: "#16a34a", category: "User", tag: "Marco", icon: "user",
    title: "New user Marco was created by Aria", actor: "Aria", email: "team@luminacrm.app", time: "12:04:59", day: "today",
    details: { Email: "marco.diaz@gmail.com", Role: "admin", "Created By": "Aria" } },
  { id: "e4", level: "success", action: "TEMPLATE SAVED", actionColor: "#16a34a", category: "System", tag: "Templates", icon: "folders",
    title: 'Drive template "Jasmine" was saved', actor: "Aria", email: "team@luminacrm.app", time: "11:20:33", day: "today",
  ...
  { id: "e5", level: "warning", action: "LOGIN FAILED", actionColor: "#d97706", category: "User", tag: "Unknown", icon: "user",
    title: "Failed login attempt for an unknown account", actor: "System", email: "security@luminacrm.app", time: "09:41:12", day: "today",
    details: { "Attempted Email": "guest@unknown.io", Reason: "Invalid password", Attempts: "3" } },
  { id: "e6", level: "error", action: "DRIVE SYNC FAILED", actionColor: "#dc2626", category: "System", tag: "Drive", icon: "database",
    title: "Google Drive sync failed for model Ava Stone", actor: "System", email: "system@luminacrm.app", time: "08:15:40", day: "today",
  ...
  { id: "e7", level: "info", action: "INITIAL SETUP", actionColor: "#2563eb", category: "System", tag: "System Setup", icon: "database",
    title: "Initial admin account created for team@luminacrm.app", actor: "Aria", email: "team@luminacrm.app", time: "17:55:02", day: "June 14, 2026",
