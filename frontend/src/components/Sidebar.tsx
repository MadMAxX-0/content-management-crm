...
const NAV: NavItem[] = [
  ...
  { href: "/register-models", icon: "uplus", label: "Register Models", pill: "Mock" },
  ...
  { href: "/drive", icon: "folder", label: "Drive Manager", pill: "Mock" },
  ...
  { group: "Analytics" },
  { href: "/social-media-tracker", icon: "share", label: "Social Media Tracker", pill: "Mock" },
  { href: "/onlyfans-statistics", icon: "dollar", label: "OnlyFans Statistics", pill: "Mock" },
  { href: "/stats", icon: "pie", label: "Analytics & Statistics" },
  { href: "/social-media-analytics", icon: "trendup", label: "Social Media Analytics", pill: "Mock" },
  { href: "/model-tasks-statistics", icon: "kanban", label: "Model Tasks Statistics", pill: "Mock" },
  { href: "/bottlenecks", icon: "alert", label: "Bottlenecks", pill: "Mock" },
  { href: "/reporting-bots", icon: "send", label: "Reporting Bots", pill: "Soon" },
  { href: "/activity-logs", icon: "listcheck", label: "Activity Logs", pill: "Mock" },
  { href: "/clock-history", icon: "clock", label: "Clock History", pill: "Mock" },
  { group: "System" },
